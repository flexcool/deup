...
import 'package:deup/pages/detail/layouts/list_layout/list_layout_item.dart';
        ...
        itemBuilder: (context, item, index) {
          return FrameSeparateWidget(
            ...
            child: GestureDetector(
              ...
              child: ListLayoutItem(object: item),
            ),
          );
        },
      ),
  ...
  Widget _buildCustomScrollView() {
    return CustomScrollView(
      ...
      slivers: <Widget>[
        ...
        SliverPadding(
          padding:
              EdgeInsets.symmetric(horizontal: CommonUtils.isPad ? 15 : 30.w)
